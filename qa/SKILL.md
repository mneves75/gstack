...
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
B=""
for _cand in   "$_ROOT/.codex/skills/gstack/browse/dist/browse"   "$_ROOT/.agents/skills/gstack/browse/dist/browse"   "$_ROOT/.claude/skills/gstack/browse/dist/browse"   "$HOME/.codex/skills/gstack/browse/dist/browse"   "$HOME/.agents/skills/gstack/browse/dist/browse"   "$HOME/.claude/skills/gstack/browse/dist/browse"; do
